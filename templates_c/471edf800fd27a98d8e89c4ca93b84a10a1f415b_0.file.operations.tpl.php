<?php
/* Smarty version 3.1.34-dev-7, created on 2019-12-23 23:13:39
  from 'C:\xampp\htdocs\mywebproject\templates\default\operations.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5e013c13825f65_19827189',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '471edf800fd27a98d8e89c4ca93b84a10a1f415b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\mywebproject\\templates\\default\\operations.tpl',
      1 => 1577138967,
      2 => 'file',
    ),
  ),
...
function content_5e013c13825f65_19827189 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
                <tr>
                    ...
                    <td><?php echo $_smarty_tpl->tpl_vars['item']->value['AccountDate'];?>
</td>
                    <td><?php echo $_smarty_tpl->tpl_vars['item']->value['TransactionDate'];?>
</td>
                    <?php if ($_smarty_tpl->tpl_vars['user']->value['Access'] > 3) {?>
                    <td><form method="get" onsubmit="send(<?php echo $_smarty_tpl->tpl_vars['item']->value['id2'];?>
); return send(<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
);">
...
foreach ($_from as $_smarty_tpl->tpl_vars['item']->value) {
?>
                                        <option value="<?php echo $_smarty_tpl->tpl_vars['item']->value['AccountDate'];?>
"> <?php echo $_smarty_tpl->tpl_vars['item']->value['AccountDate'];?>
</option>
                                    <?php
}
}
...
foreach ($_from as $_smarty_tpl->tpl_vars['item']->value) {
?>
                                        <option value="<?php echo $_smarty_tpl->tpl_vars['item']->value['TransactionDate'];?>
"> <?php echo $_smarty_tpl->tpl_vars['item']->value['TransactionDate'];?>
</option>
                                    <?php
}
}
